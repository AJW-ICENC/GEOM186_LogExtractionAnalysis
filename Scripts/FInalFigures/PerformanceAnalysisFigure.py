"""
Peak Memory Usage Through Development and Deployment
...
OUTPUT_FIGURE = (
    f"{OUTPUT_DIR}/PeakMemory_TimeSeries_V5.png"
)
...
for ax, service in zip(
    ...
    if len(deployed_jobs) > 0:
        ...
        ax.text(
            ...
            (
                "Deployed period\n"
                f"median {deployed_median:.0f} MB"
            ),
            transform=ax.get_xaxis_transform(),
            ha="right",
            va="top",
...
print("Performance memory analysis complete.")